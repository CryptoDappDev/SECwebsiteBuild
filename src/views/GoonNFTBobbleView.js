...
class GoonNFTBobbleView extends React.Component {
  static get Controller() {
    if (Controller) return Controller

    try {
      Controller = require('../controllers/GoonNFTBobbleController')
  ...
  render() {
    const proxies = GoonNFTBobbleView.Controller !== GoonNFTBobbleView ? transformProxies(this.props.children) : {
...
export default GoonNFTBobbleView
