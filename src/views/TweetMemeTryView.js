...
class TweetMemeTryView extends React.Component {
  static get Controller() {
    if (Controller) return Controller

    try {
      Controller = require('../controllers/TweetMemeTryController')
  ...
  render() {
    const proxies = TweetMemeTryView.Controller !== TweetMemeTryView ? transformProxies(this.props.children) : {
...
export default TweetMemeTryView
