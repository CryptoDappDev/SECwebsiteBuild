...
class BoardingPassPurchaseView extends React.Component {
  static get Controller() {
    ...
    try {
      ...
      if (e.code == 'MODULE_NOT_FOUND') {
        Controller = BoardingPassPurchaseView
  ...
  render() {
    const proxies = BoardingPassPurchaseView.Controller !== BoardingPassPurchaseView ? transformProxies(this.props.children) : {
...
export default BoardingPassPurchaseView
