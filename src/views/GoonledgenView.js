...
class GoonledgenView extends React.Component {
  static get Controller() {
    if (Controller) return Controller

    try {
      Controller = require('../controllers/GoonledgenController')
  ...
  render() {
    const proxies = GoonledgenView.Controller !== GoonledgenView ? transformProxies(this.props.children) : {
