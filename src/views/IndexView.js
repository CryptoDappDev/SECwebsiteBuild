...
import MemeCoinListView from './MemeCoinListView'
                ...
                <div data-w-id="293ce9ca-1abf-09ab-1b50-7431f08ddbbc" style={{opacity: 0}} className="af-class-beta-testing">
                  ...
                  <div className="af-class-div-block-89">
                    ...
                    <div className="af-class-div-block-91">
                      <a data-w-id="bc1aa2c6-b726-85a6-4a5f-292dcd83fa74" href="#" className="af-class-button-4 w-button"><span>Join the </span><span className="af-class-text-span-13">Inner-Circle</span></a>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="af-class-social-bottoms">
                <div className="af-class-div-block-93">
                  <a href="https://twitter.com/onlymemesmarket" target="_blank" className="af-class-link-block-9 w-inline-block">
                    <div data-w-id="6c9741c6-5baf-c087-da08-8c27bd372e5e" style={{WebkitTransform: 'translate3d(0, 0, 0) scale3d(1.1, 1.1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0)', MozTransform: 'translate3d(0, 0, 0) scale3d(1.1, 1.1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0)', msTransform: 'translate3d(0, 0, 0) scale3d(1.1, 1.1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0)', transform: 'translate3d(0, 0, 0) scale3d(1.1, 1.1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0)'}} className="af-class-html-embed-36 w-embed"><img src="https://secmedia.s3.us-east-2.amazonaws.com/logos/black.twitter.518px.png" alt /></div>
                  </a>
                </div>
                <div className="af-class-div-block-94">
                  <a href="https://www.reddit.com/r/OnlyMemesMarket/" target="_blank" className="af-class-link-block-10 w-inline-block">
                    <div data-w-id="00698f78-0198-ed07-8de9-1570fb0f2049" style={{WebkitTransform: 'translate3d(0, 0, 0) scale3d(1.1, 1.1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0)', MozTransform: 'translate3d(0, 0, 0) scale3d(1.1, 1.1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0)', msTransform: 'translate3d(0, 0, 0) scale3d(1.1, 1.1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0)', transform: 'translate3d(0, 0, 0) scale3d(1.1, 1.1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0)'}} className="af-class-html-embed-37 w-embed"><img src="https://secmedia.s3.us-east-2.amazonaws.com/logos/reddit.black.512.png" alt /></div>
                  </a>
                </div>
              </div>
            </div>
