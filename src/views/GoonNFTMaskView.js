...
class GoonNFTMaskView extends React.Component {
  static get Controller() {
    if (Controller) return Controller

    try {
      Controller = require('../controllers/GoonNFTMaskController')
  ...
  render() {
    const proxies = GoonNFTMaskView.Controller !== GoonNFTMaskView ? transformProxies(this.props.children) : {
...
export default GoonNFTMaskView
