        ...
        <span className="af-view">
          <div id="share-to-twitter" className="af-class-div-block-77">
            <div className="af-class-html-embed-25 w-embed w-script">
              <a href="https://twitter.com/share?ref_src=twsrc%5Etfw" className="af-class-twitter-share-button" data-size="large" data-text="Check out the $GOON Bodega on @OnlyMemesMarket" data-via="goontoken" data-hashtags="NFTs" data-show-count="false">Tweet</a>
            </div>
          </div>
        </span>
      </span>
