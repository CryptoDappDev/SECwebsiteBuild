...
class SecView extends React.Component {
  static get Controller() {
    if (Controller) return Controller

    try {
      Controller = require('../controllers/SecController')
  ...
  componentDidMount() {
    ...
    htmlEl.dataset['wfPage'] = '60d104ebb03428260c64938a'
  ...
  render() {
    const proxies = SecView.Controller !== SecView ? transformProxies(this.props.children) : {
