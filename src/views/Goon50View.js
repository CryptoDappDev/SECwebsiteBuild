...
class Goon50View extends React.Component {
  static get Controller() {
    if (Controller) return Controller

    try {
      Controller = require('../controllers/Goon50Controller')
  ...
  render() {
    const proxies = Goon50View.Controller !== Goon50View ? transformProxies(this.props.children) : {
