  ...
  render() {
    ...
    return (
      <span>
        ...
        ` }} />
        <span className="">
          <a href="#" id="connect-to-wallet-nav-goon" className=" p-2 af-class-button-3 af-class-exclusive af-class-connect-to-wallet af-class-onlymemesconnect w-button"><strong className="af-class-text-gradient-3 af-class-header-connect-waller af-class-onlymemestext">CONNECT WALLET</strong></a>
        </span>
      </span>
    )
  }
