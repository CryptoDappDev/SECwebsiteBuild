...
class OldHomeView extends React.Component {
  ...
  componentDidMount() {
    ...
    htmlEl.dataset['wfPage'] = '60cea2e97b2d629547cf92ad'
  ...
  render() {
    const proxies = OldHomeView.Controller !== OldHomeView ? transformProxies(this.props.children) : {
          ...
          <div className="af-class-body">
            <div id="body-wrapper" className="af-class-div-block-30">
              ...
              <div data-w-id="b765d888-a64f-7ef3-2f38-59e8d91c9d50" className="af-class-div-block-15">
                <div data-w-id="ad1fe3e8-a35f-7165-8f77-b8a70802d25e" className="af-class-html-embed-2 af-class-mobile-cock w-embed"><img src="https://secmedia.s3.us-east-2.amazonaws.com/sec/diamond.cock.rocket.comp.2.gif" alt="Diamond Rocket" /></div>
              </div>
              <div data-w-id="78ca0121-dce9-06b8-e00b-6f59ae1ac857" style={{opacity: 0, display: 'none'}} className="af-class-gradientborder af-class-eco" />
              <section id="SECTIONECOSLUGGGGGGGGG" data-w-id="915aa8c7-5aca-7b30-6198-454a7174844e" style={{display: 'none'}} className="af-class-section af-class-light-blue-bg af-class-features">
                <div className="af-class-container af-class-eco">
                  ...
                  <div className="w-layout-grid af-class-feature-grid">
                    <div id="w-node-_7b19d13e-0e8d-2369-5abf-e24fedfaa268-47cf92ad" data-w-id="7b19d13e-0e8d-2369-5abf-e24fedfaa268" style={{opacity: 0}} className="af-class-card-item af-class-light af-class-what-is-sec">
                    ...
                    <div id="w-node-_628315c7-9285-9cb1-4712-9cee2615c32b-47cf92ad" data-w-id="628315c7-9285-9cb1-4712-9cee2615c32b" style={{opacity: 0}} className="af-class-card-item af-class-light af-class-mememe af-class-meme">
                      ...
                      <div data-w-id="e4f0af50-e18a-97ff-f668-46d0126fa217" data-animation-type="lottie" data-src="documents/data.json" data-loop={0} data-direction={1} data-autoplay={0} data-is-ix2-target={1} data-renderer="svg" data-default-duration="4.833333333333333" data-duration={0} data-ix2-initial-state={0} className="af-class-lottie-animation-11" />
                      <div>
                    ...
                    <div id="w-node-bf82d6d8-19d5-7d71-8ac6-e7bb3b408754-47cf92ad" data-w-id="bf82d6d8-19d5-7d71-8ac6-e7bb3b408754" style={{opacity: 0}} className="af-class-card-item af-class-light af-class-tools">
                    ...
                    <div id="w-node-_0d566606-fd33-a3ac-c52c-ded5bb91b946-47cf92ad" data-w-id="0d566606-fd33-a3ac-c52c-ded5bb91b946" style={{opacity: 0}} className="af-class-card-item af-class-light af-class-tools">
                      <div className="af-class-card-item-content af-class-tools">
                        <div className="af-class-card-feature-center af-class-tool-center">
                    ...
                    <div id="w-node-_7bea1a70-4116-a7db-c374-fff947065047-47cf92ad" data-w-id="7bea1a70-4116-a7db-c374-fff947065047" style={{opacity: 0}} className="af-class-card-item af-class-light af-class-tools">
                      <div className="af-class-card-item-content af-class-tools">
                        <div className="af-class-card-feature-center af-class-tool-center">
                    ...
                    <div id="w-node-_1748d82b-49c0-8078-53ed-77133df041a2-47cf92ad" data-w-id="1748d82b-49c0-8078-53ed-77133df041a2" style={{opacity: 0}} className="af-class-card-item af-class-light af-class-contract-address">
                    ...
                    <div id="socialss" data-w-id="27b10c2b-faaf-eb26-6218-b3d0e2a19fad" style={{opacity: 0}} className="af-class-card-item af-class-light af-class-socials w-node-_27b10c2b-faaf-eb26-6218-b3d0e2a19fad-47cf92ad">
              ...
              <div data-w-id="aa1b66b6-4582-b131-9349-05a9c4ef437a" className="af-class-div-block-75">
                <div data-w-id="37d6c78a-e32d-9352-eb0d-1e2548266d5f" data-animation-type="lottie" data-src="documents/CoinRolling_V2.json" data-loop={0} data-direction={1} data-autoplay={0} data-is-ix2-target={1} data-renderer="canvas" data-default-duration="3.3333333333333335" data-duration={0} className="af-class-lottie-animation-7" />
              </div>
              ...
              <div id="About" className="af-class-section af-class-testing">
                <div className="af-class-container af-class-test">
                  <div className="w-layout-grid af-class-grid-6-col">
                    <div id="w-node-_64ab14ec-0a71-9abe-100c-83874d852302-47cf92ad" className="af-class-trusted-content">
                    ...
                    <div id="w-node-_1511bf1a-c884-944b-f323-a3f0ea7187b5-47cf92ad" className="af-class-trusted-content af-class-trusted-list">
              ...
              <section id="limited-edition-nfts-section" data-w-id="3b85f699-c949-f7e1-8df4-af4ae38e2f0c" style={{display: 'none'}} className="af-class-section af-class-dark af-class-main">
                <div className="af-class-container">
                  <div className="w-layout-grid af-class-grid-10-columns">
                    <div id="w-node-ece89d93-2df3-9c66-994e-a99360ef72ee-47cf92ad" className="af-class-content">
                      ...
                      <div className="w-layout-grid af-class-grid-6-col">
                        <div id="w-node-_74cbd762-9528-e95b-cab8-025c6f989808-47cf92ad" data-w-id="74cbd762-9528-e95b-cab8-025c6f989808" style={{opacity: 0}} className="af-class-card-item af-class-special-nft af-class-desktop">
                        ...
                        <div id="w-node-_1fddc060-866b-d6d5-cf19-68b14a53a83d-47cf92ad" data-w-id="1fddc060-866b-d6d5-cf19-68b14a53a83d" style={{opacity: 0}} className="af-class-card-item af-class-special-nft af-class-mobbbile">
                          <div className="af-class-card-item-content">
                        ...
                        <div id="w-node-_8502412a-6474-098f-1e09-76bce2a84c58-47cf92ad" data-w-id="8502412a-6474-098f-1e09-76bce2a84c58" style={{opacity: 0}} className="af-class-card-item af-class-limited-nft">
                          <div className="af-class-card-item-content">
                            ...
                            <div id="purchase-pass-button" className="af-class-nft-buy-buttons af-class-sec-coin af-class-purchase af-class-padding">
                        ...
                        <div id="w-node-_3b85f699-c949-f7e1-8df4-af4ae38e2f15-47cf92ad" data-w-id="3b85f699-c949-f7e1-8df4-af4ae38e2f15" style={{opacity: 0}} className="af-class-card-item af-class-limited-nft">
                          <div className="af-class-card-item-content">
                            <div data-w-id="e029fe69-e449-4a9b-5f1c-8ef44a11cecd" className="af-class-card-iphone af-class-coin">
                              <div className="af-class-html-embed-24 w-embed"><img src="https://secmedia.s3.us-east-2.amazonaws.com/sec/nft.coin.spinning.gif" alt="GOON" /></div>
                            </div>
                            ...
                            <div id="purchase-coin-button" className="af-class-nft-buy-buttons af-class-sec-coin af-class-purchase af-class-padding">
                  ...
                  <div className="af-class-div-block-24">
                    <div className="af-class-how-to-buy-sec-container">
                      ...
                      <div className="af-class-div-block-35">
                        <a href="https://app.sushi.com/" className="w-inline-block"><img src="images/susssshi.png" loading="lazy" height={60} width={60} srcSet="images/susssshi-p-500.png 500w, images/susssshi.png 512w" sizes="(max-width: 479px) 42vw, (max-width: 1919px) 60.000003814697266px, 100vw" alt /></a>
                  ...
                  <div className="af-class-div-block-23">
                    ...
                    <div className="af-class-download-buttons af-class-mobile-vertical af-class-small">
                      <div className="af-class-download-button af-class-sushi">
                        <a href="https://app.sushi.com/swap?outputCurrency=0x9c061df134d11412151e9c200ce3f9f6f295094a" target="_blank" className="af-class-button af-class-exclusive af-class-howtoobuyy w-inline-block"><img src="images/Apple-Icon.svg" loading="lazy" alt className="af-class-download-button-icon" />
                          <div className="af-class-text-block-10">TRADE <em>$SEC</em></div>
                        </a>
                      </div>
                      <div className="af-class-trade-sec-butt-holder">
                        <a href="https://youtu.be/RNwPNciknlU" target="_blank" className="af-class-tradesec w-button"><span className="af-class-text-gradient-1 af-class-trade-sec"><em>HOW TO</em></span></a>
                      </div>
                    </div>
                  </div>
