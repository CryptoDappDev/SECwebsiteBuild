...
const scripts = [
  ...
  {
    type: 'code',
    body: 'WebFont.load({google:{families:["Open Sans:300,300italic,400,400italic,600,600italic,700,700italic,800,800italic","Changa One:400,400italic","Manrope:200,300,regular,500,600,700,800"]}});',
    isAsync: false,
  },
  {
    type: 'src',
    body: 'https://use.typekit.net/lbo4wwl.js',
    isAsync: false,
  },
  {
    type: 'code',
  ...
  {
    type: 'code',
    body: 'function gtag(){dataLayer.push(arguments)}window.dataLayer=window.dataLayer||[],gtag("js",new Date),gtag("config","G-CVK9N1TKEW",{anonymize_ip:!1});',
    isAsync: false,
  },
]
